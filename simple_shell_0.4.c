 ...
 *
 * This function takes an array of strings containing the command and its
 * arguments and executes the command in a child process using the execvp
 * system call. The parent process waits for the child to complete before
 * continuing.
 */
...
int tokenize_arguments(char *command, char **arguments)
{
	...
	!= NULL && num_arguments < MAX_NUM_ARGUMENTS)
	{
